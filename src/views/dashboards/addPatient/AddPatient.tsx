  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        ...
        <Card>
          <CardContent>
            <CustomTextField fullWidth label='Height' sx={{ mb: 2 }} />
            <CustomTextField fullWidth label='Weight' sx={{ mb: 2 }} />
            <CustomTextField fullWidth label='BP' sx={{ mb: 2 }} />
            <CustomTextField fullWidth label='Pulse' sx={{ mb: 2 }} />
            <CustomTextField fullWidth label='Temperature' sx={{ mb: 2 }} />
            <CustomTextField fullWidth label='Respiration' sx={{ mb: 2 }} />
            <CustomTextField
              select
              fullWidth
              label='Symptoms Type'
              ...
              sx={{ mb: 4 }}
            >
              <MenuItem value='Symptom Type 1'>Symptom Type 1</MenuItem>
              <MenuItem value='Symptom Type 2'>Symptom Type 2</MenuItem>
              <MenuItem value='Symptom Type 3'>Symptom Type 3</MenuItem>
            </CustomTextField>
            <CustomTextField fullWidth label='Symptoms Title' sx={{ mb: 2 }} />
            <CustomTextField fullWidth label='Symptoms Description' sx={{ mb: 2 }} />
            <CustomTextField fullWidth label='Note' sx={{ mb: 2 }} />
            <CustomTextField fullWidth label='Any Known Allergies' sx={{ mb: 2 }} />
            <CustomTextField fullWidth label='Previous Medical Issue' sx={{ mb: 2 }} />
