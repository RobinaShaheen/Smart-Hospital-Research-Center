...
const dummyData = [
  ...
  },
  {
    ...
    bloodGroup: 'A',
    component:'White cell & Granulocytes',
    gender: 'xx',
    donorName: 'abc',
    bags: 2,
    bloodQty: 50,
...
const columns: GridColDef[] = [
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row.component}</Typography>
  },
  {
    flex: 0.2,
    field: 'gender',
    ...
    <Card>
      ...
      >
        ...
        <Button
          component={Link}
          variant='contained'
          href='/billing/bloodComponentBilling/issueComponent'
