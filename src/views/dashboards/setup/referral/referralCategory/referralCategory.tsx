...
const dummyData = [
  ...
  {
    id: 4,
    Name: 'Clinical Services within the Community',
    Action: ''
  },
  {
    id: 5,
    Name: 'Valuing the Benefit of Clinical Services',
    Action: ''
  }
]
...
const ReferralCategory = () => {
  ...
  return (
    <Card>
      ...
      >
        Referral Category List
      </Typography>
      <Button
          component={Link}
          variant='contained'
          href='/Setup/Referral/addReferralCategory'
...
export default ReferralCategory
