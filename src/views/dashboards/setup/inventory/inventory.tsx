    ...
    <Grid container spacing={6}>
      <Grid item>
        <Card>
          <CardContent>
            <OptionsWrapper>
              <StyledLink onClick={() => onSelectInventory('ItemCategory')} sx={{"&:focus": {color: 'blue'}, fontSize: '20px'}}>Item Category</StyledLink>
              <StyledLink onClick={() => onSelectInventory('ItemStore')} sx={{"&:focus": {color: 'blue'}, fontSize: '20px'}}>Item Store</StyledLink>
              <StyledLink onClick={() => onSelectInventory('ItemSupplier')} sx={{"&:focus": {color: 'blue'}, fontSize: '20px'}}>Item Supplier</StyledLink>
